                        ...
                        {integrations.map((item, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div
                                        className={`relative flex h-36 w-36 items-center justify-center rounded-full border-2 bg-gradient-to-b p-4 backdrop-blur-2xl transition-all duration-500 ${item.color
                                            } ${isSelected
